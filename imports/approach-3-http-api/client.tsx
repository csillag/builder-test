...
function callMethod<ResultType = void>(name: string, query?: Record<string, any>): Promise<ResultType> {
...
const api: DataAPI = {
    ...
    setCertified: (id: string, value: boolean) => callMethod('set-certified', { id, value }),
...
export const HttpApiDemoApp = () => {
    ...
    return (
        <>
            ...
            />
            <hr />
            <Button onClick={() => api.showAllHidden().then(reload)}>Show all hidden companies</Button>
