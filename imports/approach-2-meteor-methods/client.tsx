 ...
 */
const api: DataAPI = {
    loadData: (query, callback) => Meteor.call('d2GetCompanyList', query, callback),

    setCertified: (id, value, callback) => Meteor.call('d2SetCertified', id, value, callback),
...
export const MethodsDemoApp = () => {
    ...
    return (
        <>
            ...
            />
            <hr />
            <Button onClick={() => api.showAllHidden(reload)}>Show all hidden companies</Button>
